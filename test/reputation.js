...
contract('Reputation', accounts => {
    it("test setting and getting reputation by the owner", async () => {
        ...
        value = await reputation.getReputationOf(accounts[1]);
    ...
    it("check permissions", async () => {
        ...
        let account0Rep = await rep.getReputationOf(accounts[0]);
        let account1Rep = await rep.getReputationOf(accounts[1]);
        let account2Rep = await rep.getReputationOf(accounts[2]);
    ...
    it("mint (plus) should be reflected in balances", async () => {
        ...
        const amount = await reputation.getReputationOf(accounts[1]);
    ...
    it("mint (minus) should be reflected in balances", async () => {
        ...
        let amount = await reputation.getReputationOf(accounts[1]);

        assert.equal(amount.toNumber(), 500);

        await reputation.burn(accounts[1], 700, { from: accounts[0] });
        amount = await reputation.getReputationOf(accounts[1]);
    ...
    it("account balance cannot be negative", async () => {
        ...
        let rep = await reputation.getReputationOf(accounts[1]);
    ...
    it("reputationOf = balances", async () => {
        ...
        const reputationOf1 = await reputation.getReputationOf(accounts[1]);
        const reputationOf2 = await reputation.getReputationOf(accounts[2]);
        const reputationOf3 = await reputation.getReputationOf(accounts[3]);
